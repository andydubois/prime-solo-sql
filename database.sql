...
INSERT INTO "accounts"("username", "city", "transactions_completed", "transactions_attempted", "account_balance") VALUES('andy', 'savage', 20, 25, 1000000000.00);
...
WHERE ("city" ILIKE 'miami' AND "transactions_completed" < 5) OR ("city" ILIKE 'phoenix' AND "transactions_completed" < 5);